...
public class LruMemoryCache implements ImageLoader.ImageCache {
     ...
     * 推荐内存缓存大小
     */
    public static final int REC_CAHCE_SIZE = 2 * 1024 * 1024;
    ...
    /**
     * Returns the Bitmap for {@code url} if it exists in the cache. If a Bitmap was returned, it is
     * moved to the head of the queue. This returns null if a Bitmap is not cached.
     */
    @Override
    ...
    /**
     * Caches {@code Bitmap} for {@code url}. The Bitmap is moved to the head of the queue.
     */
    @Override
